...
SLVideoDialog::SLVideoDialog(const QString &title, QWidget *parent)
    : QDialog(parent), ui(new Ui::SLVideoDialog) {
    ui->setupUi(this);
...
QAction *SLVideoDialog::toggleViewAction() { return action; }
...
void SLVideoDialog::closeEvent(QCloseEvent *) { action->setChecked(false); }

SLVideoDialog::~SLVideoDialog() { delete ui; }
