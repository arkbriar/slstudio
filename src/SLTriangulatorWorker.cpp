...
void SLTriangulatorWorker::triangulatePointCloud(cv::Mat up, cv::Mat vp, cv::Mat mask,
                                                 cv::Mat shading) {
    ...
    //    pcl::PointCloud<pcl::PointXYZRGB>::Ptr pointCloudFiltered(new
    //    pcl::PointCloud<pcl::PointXYZRGB>); filter.filter(*pointCloudFiltered);
