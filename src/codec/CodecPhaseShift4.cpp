...
// Encoder
EncoderPhaseShift4::EncoderPhaseShift4(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
cv::Mat EncoderPhaseShift4::getEncodingPattern(unsigned int depth) { return patterns[depth]; }

// Decoder
DecoderPhaseShift4::DecoderPhaseShift4(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
void DecoderPhaseShift4::setFrame(unsigned int depth, cv::Mat frame) { frames[depth] = frame; }
