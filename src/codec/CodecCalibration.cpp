...
EncoderCalibration::EncoderCalibration(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
cv::Mat EncoderCalibration::getEncodingPattern(unsigned int depth) { return patterns[depth]; }

// Decoder
DecoderCalibration::DecoderCalibration(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
void DecoderCalibration::setFrame(unsigned int depth, cv::Mat frame) { frames[depth] = frame; }
