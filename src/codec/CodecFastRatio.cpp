...
// Encoder
EncoderFastRatio::EncoderFastRatio(unsigned int _screenCols, unsigned int _screenRows,
                                   CodecDir _dir)
...
cv::Mat EncoderFastRatio::getEncodingPattern(unsigned int depth) { return patterns[depth]; }

// Decoder
DecoderFastRatio::DecoderFastRatio(unsigned int _screenCols, unsigned int _screenRows,
                                   CodecDir _dir)
...
void DecoderFastRatio::setFrame(unsigned int depth, cv::Mat frame) { frames[depth] = frame; }
