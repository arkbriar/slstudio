...
EncoderPhaseShift2x3::EncoderPhaseShift2x3(unsigned int _screenCols, unsigned int _screenRows,
                                           CodecDir _dir)
...
cv::Mat EncoderPhaseShift2x3::getEncodingPattern(unsigned int depth) { return patterns[depth]; }

// Decoder
DecoderPhaseShift2x3::DecoderPhaseShift2x3(unsigned int _screenCols, unsigned int _screenRows,
                                           CodecDir _dir)
...
void DecoderPhaseShift2x3::setFrame(unsigned int depth, cv::Mat frame) { frames[depth] = frame; }
