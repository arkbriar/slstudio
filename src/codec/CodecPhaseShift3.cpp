...
// Encoder
EncoderPhaseShift3::EncoderPhaseShift3(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
cv::Mat EncoderPhaseShift3::getEncodingPattern(unsigned int depth) { return patterns[depth]; }

// Decoder
DecoderPhaseShift3::DecoderPhaseShift3(unsigned int _screenCols, unsigned int _screenRows,
                                       CodecDir _dir)
...
void DecoderPhaseShift3::setFrame(unsigned int depth, cv::Mat frame) { frames[depth] = frame; }
