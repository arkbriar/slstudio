...
// Encoder
EncoderPhaseShift3DirectLight::EncoderPhaseShift3DirectLight(unsigned int _screenCols,
...
// Decoder
DecoderPhaseShift3DirectLight::DecoderPhaseShift3DirectLight(unsigned int _screenCols,
                                                             unsigned int _screenRows,
                                                             CodecDir _dir)
...
void DecoderPhaseShift3DirectLight::decodeFrames(cv::Mat &up, cv::Mat &vp, cv::Mat &mask,
                                                 cv::Mat &shading) {
