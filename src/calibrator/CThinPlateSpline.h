...
cv::Point2f-structure
    ...
    **************************************************************************
    ...
    @param src                                      Reference to the source image. Nothing will be
    done with this array other than reading values.
    ...
    @return                                 void
    ***************************************************************************/
    void warpImage(const Mat& src, Mat& dst, float lambda = 0.001,
    ...
    **************************************************************************
    ...
    @return                                 void
    ***************************************************************************/
    void computeMaps(const Size& dstSize, Mat_<float>& mapx, Mat_<float>& mapy,
                     const TPS_INTERPOLATION tpsInter = BACK_WARP);
    ...
    ****************************************************************************/
    ...
    void computeSplineCoeffs(std::vector<Point2f>& iP, std::vector<Point2f>& iiP, float lambda,
                             const TPS_INTERPOLATION tpsInter = BACK_WARP);
