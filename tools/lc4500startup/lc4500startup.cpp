...
void showError(std::string err) { std::cerr << "lc4500startup: " << err << std::endl; }
...
int main() {
    ...
    if (LCR_AddToPatLut(TrigType, PatNum, BitDepth, LEDSelectRed, InvertPat, InsertBlack, BufSwap,
                        trigOutPrev) == -1) {
